package Assignment.KeywordDriven.keyword;
...
public class ActionKeyword {
	...
	public static void clickLogin(String locatorType, String locatorValue) {
		WebElement element = getElement(locatorType, locatorValue);
		element.click();

	}

	public static void clickLogout(String locatorType, String locatorValue) {
		WebElement element = getElement(locatorType, locatorValue);
		element.click();
	}
