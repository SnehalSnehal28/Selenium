...
public class LoginTest {
	...
	public void testLogin(String username, String password) {
		...
		driver.findElement(By.xpath("/html/body/div/div/div[3]/input")).sendKeys(password);
	...
	public void beforeMethod() {
	  System.setProperty("webdriver.chrome.driver", "C:\\Users\\sneha\\eclipse-workspace\\FrameWorks\\src\\test\\java\\webdriver//chromedriver.exe");
